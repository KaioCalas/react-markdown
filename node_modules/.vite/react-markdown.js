...
function initializeContent(effects) {
  ...
  function paragraphInitial(code2) {
    ok(code2 !== codes.eof && !markdownLineEnding(code2), "expected anything other than a line ending or EOF");
...
function tokenizeContainer(effects, ok3, nok) {
  return factorySpace(effects, effects.attempt(this.parser.constructs.document, ok3, nok), types.linePrefix, this.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize);
}
...
function tokenizeAttention(effects, ok3) {
  ...
  return start;
  function start(code2) {
    ok(code2 === codes.asterisk || code2 === codes.underscore, "expected asterisk or underscore");
...
function tokenizeBlockQuoteContinuation(effects, ok3, nok) {
  return factorySpace(effects, effects.attempt(blockQuote, ok3, nok), types.linePrefix, this.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize);
}
...
function tokenizeCodeFenced(effects, ok3, nok) {
  ...
  return start;
  function start(code2) {
    ok(code2 === codes.graveAccent || code2 === codes.tilde, "expected `` ` `` or `~`");
  ...
  function contentStart(code2) {
    ...
    if (markdownLineEnding(code2)) {
      return effects.attempt(nonLazyLine, effects.attempt(closingFenceConstruct, after, initialPrefix ? factorySpace(effects, contentStart, types.linePrefix, initialPrefix + 1) : contentStart), after)(code2);
    }
  ...
  function tokenizeClosingFence(effects2, ok4, nok2) {
    let size = 0;
    return factorySpace(effects2, closingSequenceStart, types.linePrefix, this.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize);
...
function tokenizeCodeIndented(effects, ok3, nok) {
  ...
  function start(code2) {
    ...
    return factorySpace(effects, afterStartPrefix, types.linePrefix, constants.tabSize + 1)(code2);
  }
...
function tokenizeIndentedContent(effects, ok3, nok) {
  ...
  function start(code2) {
    ...
    return factorySpace(effects, afterPrefix, types.linePrefix, constants.tabSize + 1)(code2);
  }
  function afterPrefix(code2) {
    const tail = self.events[self.events.length - 1];
...
function tokenizeContent(effects, ok3) {
  ...
  return start;
  function start(code2) {
    ok(code2 !== codes.eof && !markdownLineEnding(code2), "expected no eof or eol");
...
function factoryTitle(effects, ok3, nok, type, markerType, stringType) {
  ...
  return start;
  function start(code2) {
    ok(code2 === codes.quotationMark || code2 === codes.apostrophe || code2 === codes.leftParenthesis, "expected `\"`, `'`, or `(`");
    effects.enter(type);
    effects.enter(markerType);
    effects.consume(code2);
    effects.exit(markerType);
...
function factoryWhitespace(effects, ok3) {
  ...
  function start(code2) {
    ...
    if (markdownSpace(code2)) {
      return factorySpace(effects, start, seen ? types.linePrefix : types.lineSuffix)(code2);
    }
    return ok3(code2);
  }
}
...
function tokenizeDefinition(effects, ok3, nok) {
  ...
  function start(code2) {
    ...
    return factoryLabel.call(self, effects, labelAfter, nok, types.definitionLabel, types.definitionLabelMarker, types.definitionLabelString)(code2);
  }
...
function tokenizeTitle(effects, ok3, nok) {
  ...
  function before(code2) {
    if (code2 === codes.quotationMark || code2 === codes.apostrophe || code2 === codes.leftParenthesis) {
      return factoryTitle(effects, factorySpace(effects, after, types.whitespace), nok, types.definitionTitle, types.definitionTitleMarker, types.definitionTitleString)(code2);
    }
    return nok(code2);
  }
  function after(code2) {
...
function tokenizeHtmlFlow(effects, ok3, nok) {
  ...
  function htmlContinueStart(code2) {
    ...
    if (markdownLineEnding(code2)) {
      return effects.attempt({ tokenize: htmlLineEnd, partial: true }, htmlContinueStart, done)(code2);
    }
    effects.enter(types.htmlFlowData);
...
function tokenizeHtmlText(effects, ok3, nok) {
  ...
  function atLineEnding(code2) {
    ...
    effects.consume(code2);
    effects.exit(types.lineEnding);
    return factorySpace(effects, afterPrefix, types.linePrefix, self.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize);
  }
  function afterPrefix(code2) {
    effects.enter(types.htmlTextData);
...
function tokenizeResource(effects, ok3, nok) {
  ...
  function open(code2) {
    ...
    return factoryDestination(effects, destinationAfter, nok, types.resourceDestination, types.resourceDestinationLiteral, types.resourceDestinationLiteralMarker, types.resourceDestinationRaw, types.resourceDestinationString, constants.linkResourceDestinationBalanceMax)(code2);
  }
  ...
  function between(code2) {
    if (code2 === codes.quotationMark || code2 === codes.apostrophe || code2 === codes.leftParenthesis) {
      return factoryTitle(effects, factoryWhitespace(effects, end), nok, types.resourceTitle, types.resourceTitleMarker, types.resourceTitleString)(code2);
    }
    return end(code2);
  }
  function end(code2) {
...
function tokenizeFullReference(effects, ok3, nok) {
  ...
  function start(code2) {
    ...
    return factoryLabel.call(self, effects, afterLabel, nok, types.reference, types.referenceMarker, types.referenceString)(code2);
  }
...
function tokenizeThematicBreak(effects, ok3, nok) {
  ...
  return start;
  function start(code2) {
    ok(code2 === codes.asterisk || code2 === codes.dash || code2 === codes.underscore, "expected `*`, `-`, or `_`");
...
function tokenizeListContinuation(effects, ok3, nok) {
  ...
  function onBlank(code2) {
    ...
    return factorySpace(effects, ok3, types.listItemIndent, self.containerState.size + 1)(code2);
  }
  ...
  function notInCurrentItem(code2) {
    ...
    self.interrupt = void 0;
    return factorySpace(effects, effects.attempt(list, ok3, nok), types.linePrefix, self.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize)(code2);
  }
}
...
function tokenizeSetextUnderline(effects, ok3, nok) {
  ...
  return start;
  function start(code2) {
    ok(code2 === codes.dash || code2 === codes.equalsTo, "expected `=` or `-`");
...
function createTokenizer(parser, initialize, from) {
  let point3 = Object.assign(from ? Object.assign({}, from) : { line: 1, column: 1, offset: 0 }, { _index: 0, _bufferIndex: -1 });
  const columnStart = {};
  ...
  function consume(code2) {
    ...
    ok(code2 === null ? context.events.length === 0 || context.events[context.events.length - 1][0] === "exit" : context.events[context.events.length - 1][0] === "enter", "expected last token to be open");
    if (markdownLineEnding(code2)) {
      point3.line++;
      point3.column = 1;
...
function stringify3(values2, options) {
  ...
  return values2.join((settings.padRight ? " " : "") + "," + (settings.padLeft === false ? "" : " ")).trim();
}
